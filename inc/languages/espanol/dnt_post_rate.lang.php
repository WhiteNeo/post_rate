...
$l['dnt_prt_rated'] = "Se ha agregado su emoción correctamente.Da click en tu emoción para quitarla";
...
$l['dnt_prt_view_all_mp'] = '<span style="float:right;"><a href="{1}">Ver Todas</a></span>';
$l['dnt_prt_total_best_mp'] = "El mejor mensaje de este usuario con {1} emociones es:<br />";
...
$l['dnt_prt_rates_receivedu'] = '<span style="display:block">Emociones recibidas: {1}</span>';
$l['dnt_prt_dont_rates'] = "Este usuario aún no contiene mensajes con emociones, sé el primero en darle una emotividad :) !!!";
...
$l['dnt_prt_like'] = "Me gusta";
$l['dnt_prt_love'] = "Me encanta";
$l['dnt_prt_wow'] = "Me sorprende";
$l['dnt_prt_smile'] = "Me alegra";
$l['dnt_prt_cry'] = "Me entristece";
$l['dnt_prt_angry'] = "Me enfada";
$l['dnt_prt_remove_rate_question'] = "Quieres eliminar tu emoción en este mensaje?";
...
$l['dnt_prt_rates_given'] = "Emociones Brindadas";
$l['dnt_prt_rates_received'] = "Emociones Recibidas";
$l['dnt_prt_rates_given_mp'] = "<span style=\"display:block\">Emociones Brindadas: <strong><a href=\"{2}\">{1}</a></strong></span>";
$l['dnt_prt_rates_received_mp'] = "<span style=\"display:block\">Emociones Recibidas: <strong><a href=\"{2}\">{1}</a></strong></span>";
...
$l['dnt_prt_wol'] = 'Viendo <a href="{1}" target="_blank">{2}</a>';