...
$l['pcl_rates_post'] = '<span style="display:block">Rates for this post: {1}</span>';
$l['pcl_rates_thread'] = '<span style="display:block">Rates in this thread: {1}</span>';
$l['pcl_rates_givenu'] = '<span style="display:block">Rates Given: {1}</span>';
$l['pcl_rates_receivedu'] = '<span style="display:block">Rates Received: {1}/span>';
