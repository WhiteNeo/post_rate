...
$l['dnt_prt_total_best'] = "The best rated thread of this user with {1} times is:<br />";
$l['dnt_prt_rates_post'] = '<span style="display:block">Rates for this post: {1}</span>';
$l['dnt_prt_rates_thread'] = '<span style="display:block">Rates in this thread: {1}</span>';
$l['dnt_prt_rates_givenu'] = '<span style="display:block">Rates Given: {1}</span>';
$l['dnt_prt_rates_receivedu'] = '<span style="display:block">Rates Received: {1}/span>';
$l['dnt_prt_dont_rates'] = "This user has not post rates yet, be the first in rate it :) !!!";
